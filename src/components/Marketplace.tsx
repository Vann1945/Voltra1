  ...
  return (
    <section id="explore" className="relative min-h-screen pb-12" aria-label="Marketplace Explore">
      ...
      <div className="relative overflow-hidden bg-zinc-950 pt-28 pb-20 border-b border-white/5">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[300px] bg-white/[0.03] rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          >
            ...
            <p className="text-zinc-400 text-lg max-w-2xl mx-auto font-medium tracking-wide">
              Explore premium resource packs, mods, and worlds crafted by the community.
            </p>
          </motion.div>
          {/* Search & Filter */}
          <motion.div 
                ...
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pt-4 border-t border-white/5 mt-2">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/5 bg-black/40 py-2.5 pl-3 pr-8 text-sm text-white focus:border-white/20 focus:outline-none focus:ring-1 focus:ring-white/20 transition-colors appearance-none"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/5 bg-black/40 py-2.5 px-3 text-sm text-white placeholder-zinc-600 focus:border-white/20 focus:outline-none focus:ring-1 focus:ring-white/20 transition-colors"
                    />
                  </div>
                </div>
